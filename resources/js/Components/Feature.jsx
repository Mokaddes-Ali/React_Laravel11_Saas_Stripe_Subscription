...
//     const availableCredits = Number(auth.user.available_credits);
//     console.log(auth.user);
// const requiredCredits = Number(feature.required_credits);
                            ...
                            feature.required_credits > availableCredits && (
                                <div className="absolute left-0 top-0 right-0 bottom-0 z-20 flex flex-col items-center justify-center bg-white/70 gap-3 text-red-500">
                                    ...
                                    <div>
                                        ...
                                        <Link href={route('credit.index')} className="text-blue-500 underline">
                                            Buy More Credits
                                        </Link>
                                    </div>
                                </div>
